...
export default function SignupPage() {
  ...
  const submit = async () => {
    ...
    setBusy(true);
    try {
      // ✅ You imported `register` from ../api/auth
        ...
        >
          ...
          >
            ...
            <Typography sx={{ mt: 0.6, color: "rgba(20,35,55,0.65)" }}>
              Set up your credentials to start.
            </Typography>

            <Divider sx={{ my: 2.5, borderColor: "rgba(15,25,40,0.10)" }} />
            ...
            >
              ...
              <Typography
                variant="caption"
                sx={{ textAlign: "center", color: "rgba(20,35,55,0.55)" }}
              >
          ...
          <Box sx={{ display: "flex", justifyContent: { xs: "stretch", md: "flex-end" }, alignItems: "center" }}>
            ...
            >
              <InfoCard title="Identity" subtitle="Create your secure profile" icon={<PersonRoundedIcon />} />
              <InfoCard title="Protection" subtitle="Your password is encrypted" icon={<LockRoundedIcon />} />
              <InfoCard title="Access" subtitle="Role-based dashboards after login" icon={<VerifiedUserRoundedIcon />} />
            </Stack>
          </Box>
        </Box>
      </Container>
